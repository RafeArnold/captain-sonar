package uk.co.rafearnold.captainsonar.eventapi.v1.vertx.model.codec
...
@Singleton
internal class VertxGameEventEventApiV1ModelCodec @Inject constructor(
    ...
    companion object {
        val name: String = VertxGameEventEventApiV1ModelCodec::class.java.name
    }
}
